...
def merge_netbox_csvs():
    ...
    try:
        ...
        with open(vms_file, encoding="utf-8") as f:
        ...
        with open(output_file, "w", newline="", encoding="utf-8") as outfile:
            ...
            with open(devices_file, encoding="utf-8") as f:
                ...
                for row in reader:
                    ...
                    for header, value in zip(devices_headers, row, strict=False):
            ...
            with open(vms_file, encoding="utf-8") as f:
                ...
                for row in reader:
                    ...
                    for header, value in zip(vms_headers, row, strict=False):
                        if header in merged_headers:
                            merged_idx = merged_headers.index(header)
                            merged_row[merged_idx] = value
        ...
        print(f"Error during merge process: {e!s}")
        return False
...
def create_excel_export(csv_file, excel_file):
    ...
    try:
        ...
        print(f"Error creating Excel export: {e!s}")
        return False

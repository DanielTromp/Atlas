        ...
        try:
            ...
            if vm:
                ...
                if hasattr(vm, 'custom_fields') and vm.custom_fields:
                    ...
                    if 'Virtual_Disks' in custom_fields and custom_fields['Virtual_Disks']:
                        vm_data['Virtual Disks'] = str(custom_fields['Virtual_Disks'])
                    
                    if 'Backup' in custom_fields and custom_fields['Backup']:
                        vm_data['Backup'] = str(custom_fields['Backup'])
                    
                    if 'DTAP_state' in custom_fields and custom_fields['DTAP_state']:
                        vm_data['DTAP state'] = str(custom_fields['DTAP_state'])
                    
                    if 'Harddisk' in custom_fields and custom_fields['Harddisk']:
                        vm_data['Harddisk'] = str(custom_fields['Harddisk'])
                    
                    if 'open_actions' in custom_fields and custom_fields['open_actions']:
                        vm_data['open actions'] = str(custom_fields['open_actions'])
                    
                    if 'Server_Group' in custom_fields and custom_fields['Server_Group']:

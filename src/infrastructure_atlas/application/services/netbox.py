...
from infrastructure_atlas.application.exporter.netbox import (
    ExportPaths,
    LegacyScriptNetboxExporter,
    NativeNetboxExporter,
)
from infrastructure_atlas.application.orchestration import JobHandler
...
class NetboxExportService:
    ...
    def _reconcile_resource(  # noqa: PLR0913
        self,
        *,
        resource: str,
        ...
        if fetch_targets:
            ...
            for identifier in fetch_targets:
                ...
                try:
                    ...
                    self._logger.debug(
                        "Failed to fetch NetBox %s individually",
                        resource,
                        extra={"error": str(exc), "identifier": identifier},
                    )
                    continue

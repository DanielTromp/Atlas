...
from enreach_tools.db.models import SecureSetting

logger = logging.getLogger(__name__)

SECRET_KEY_ENV = "ENREACH_SECRET_KEY"  # noqa: S105 - env var name, not a secret value
...
def _has_secure_table() -> bool:
    try:
        from enreach_tools.db.config import get_engine
...
def sync_secure_settings(keys: Iterable[str] | None = None) -> None:
    ...
    from enreach_tools.db.config import get_sessionmaker

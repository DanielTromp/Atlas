...
_CONFIG_FIELDS: tuple[dict[str, Any], ...] = (
    ...
    {"key": "ENREACH_DEFAULT_ADMIN_USERNAME", "label": "Default Admin User", "secret": False},
    {"key": "ENREACH_DEFAULT_ADMIN_PASSWORD", "label": "Default Admin Password", "secret": True},
)
...
class AdminConfigSurveyTool(EnreachTool):
...
class AdminBackupStatusTool(EnreachTool):

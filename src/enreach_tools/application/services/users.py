...
def create_user_service(
    ...
    if user_repo_factory is None:
        from enreach_tools.infrastructure.db.repositories import SqlAlchemyUserRepository

        user_repo_factory = SqlAlchemyUserRepository
    if user_key_repo_factory is None:
        from enreach_tools.infrastructure.db.repositories import SqlAlchemyUserAPIKeyRepository
